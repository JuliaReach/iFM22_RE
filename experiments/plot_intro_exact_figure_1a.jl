...
plot!(fig, X0, c=:yellow, alpha=1., lab=L"X_0")
plot!(fig, sol_fw[1501:2000], vars=(1, 2), lw=0.1, c=:orange, alpha=0.8, lab=L"R_{[3\delta/10, 4\delta/10]}")
plot!(fig, sol_fw[end], vars=(1, 2), c=:green, alpha=0.8, lab=L"R_\delta")
[plot!(fig, s, vars=(1, 2), c=:magenta, seriestype=:path, marker=:none) for s in sol_orbit]

savefig(fig, "intro_exact.pdf")
